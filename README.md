...
Starburst [works](https://secure.travis-ci.org/starburstgem/starburst) on Rails 6.0, 6.1 and 7.0. It should work with the same Ruby runtime versions supported by each framework version.
